<div class="models-item">
                      ...
                      <div>
                          <h3>DEFINE</h3>
                          <p class="text">This is our proposal stage where we define and clarify issues in our
                  ...
                  <div class="models-item">
                    ...
                    <div>
                        <h3>DEEP DIVE</h3>
                        <p class="text">This is our requirements gathering stage. We engage with the client
                    ...
                    <div>
                        <h3>DESIGN</h3>
                        <p class="text">We develop a customized scope of work and a list of activities hinged
                ...
                <div class="models-item">
                    ...
                    <div>
                        <h3>DELIVER</h3>
                        <p class="text">We implement and measure results in this stage</p>
                    </div>
                </div>       